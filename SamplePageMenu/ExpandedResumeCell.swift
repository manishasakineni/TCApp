...
class ExpandedResumeCell: UITableViewCell {
    ...
    @IBOutlet weak var docBackGroundView: UIView!
    
    @IBOutlet weak var docViewHeightConst: NSLayoutConstraint!
    @IBOutlet weak var docCollactionView: UICollectionView!
