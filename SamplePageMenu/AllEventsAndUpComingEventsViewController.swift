...
class AllEventsAndUpComingEventsViewController: UIViewController,CAPSPageMenuDelegate,eventinfoSubtitleOfIndexDelegate {
 ...
 //MARK: -    view Will Appear
    ...
    //    Utilities.UpComingAndEventViewControllerNavBarColorInCntrWithColor(backImage: "icons8-arrows_long_left", cntr:self, titleView: nil, withText: , backTitle: "" , rightImage: "homeImg", secondRightImage: "Up", thirdRightImage: "Up")
        
        Utilities.eventDetailsAndEventPostDetailsViewControllerNavBarColorInCntrWithColor(backImage: "icons8-arrows_long_left", cntr:self, titleView: nil, withText: "Events".localize(), backTitle: " ", rightImage: "homeImg", secondRightImage: "Up", thirdRightImage: "Up")
