...
//MARK: -  variable declaration
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        Utilities.eventDetailsAndEventPostDetailsViewControllerNavBarColorInCntrWithColor(backImage: "icons8-arrows_long_left", cntr:self, titleView: nil, withText: "", backTitle: " \(eventName)", rightImage: "homeImg", secondRightImage: "Up", thirdRightImage: "Up")
